...
```{r 'get sqlite db', eval=T}
  GEOmetadb_loc <- "../data/GEOmetadb.sqlite.gz"
	library(GEOmetadb)
  if (!file.exists(GEOmetadb_loc)) {
  download.file('https://gbnci-abcc.ncifcrf.gov/geo/GEOmetadb.sqlite.gz', GEOmetadb_loc)
  gunzip('../data/GEOmetadb.sqlite.gz', destname = '../data/GEOmetadb_sqlite')
  }
```

```{r 'configurations, objects, and settings', eval=T}
GEOmetadb_loc <- "../data/GEOmetadb_sqlite"
